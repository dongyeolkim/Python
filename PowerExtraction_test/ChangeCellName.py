    ...
    for netname in extnetnames:
        ...
        if file:
            try:
                ...
                f.write("  a=gdmCreateSpec(" + " " + "\"" + window.libname.text() + "_" + window.rev.text() + "_" + netname + "_" + window.date.text() +"\"" + " " 
                    + "\"" + window.cellname.text() + "\"" + " " +  "\"" + window.viewname.text() + "\"" + " " + "nil" + " " + "\"" + "CDBA" + "\"" + " )\n" )

                if window.hiercheck.isChecked():
                    f.write("  b=gdmCreateSpec(" + " " + "\"" + window.libname.text() + "_" + window.rev.text() + "_" + netname + "_" + window.date.text() +"\"" + " " 
...
#==============================================================================
    ...
    command="icfb -ilLoadIL rename.il -nograph -log rename_" + pwr + ".log"
