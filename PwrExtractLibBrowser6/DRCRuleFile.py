...
#    window.strmin_tb.append(workdir)
    ...
    PRES1=window.PRES1.text().split(',')
    PRES2=window.PRES2.text().split(',')
...
#==============================================================================
        ...
        if window.PRES1.text() != "":
            f.write("LAYER MAP " + PRES1[2] + " DATATYPE " + PRES1[3] + ' ' + PRES1[2] + PRES1[3] + "\n")
            f.write("LAYER " + PRES1[0] + " " + PRES1[2] + PRES1[3] + "\n\n" )
        if window.PRES2.text() != "":
            f.write("LAYER MAP " + PRES2[2] + " DATATYPE " + PRES2[3] + ' ' + PRES2[2] + PRES2[3] + "\n")
            f.write("LAYER " + PRES2[0] + " " + PRES2[2] + PRES2[3] + "\n\n" )
...
#        msg.exec_()
        ...
        if MIMLOC == "P1-P2":
            f.write( "Pure" + P1[0] + " = " + P1[0] + " NOT " + PRES1[0] + "\n")
            ...
            if window.PRES1.text() != "":
                if window.PRES2.text() != "":
                    f.write( "Temp" + P1[0] + " = " + P1[0] + " NOT " + PRES1[0] + "\n")
                    f.write( "Pure" + P1[0] + " = " + "Temp" + P1[0] + " NOT " + PRES2[0] + "\n")
                else:
                    f.write( "Pure" + P1[0] + " = " + P1[0] + " NOT " + PRES1[0] + "\n")
