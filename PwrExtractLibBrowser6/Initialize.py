            ...
            for line in data:            
                ...
                if( len(words) ==2 ):
                    ...
                    if var2 == 'rundir':
                        ...
                        window.PRES1.setText(var1)
                    elif var2== 'PRES2':
                        window.PRES2.setText(var1)
                    elif var2== 'P1':
                        ...
                        window.M5.setText(var1)
                    elif var2 == 'M6':
                        window.M6.setText(var1)
                    elif var2 == 'M7':
                        window.M7.setText(var1)
                    elif var2== 'M1TXT':
                        ...
                        window.M5TXT.setText(var1)
                    elif var2== 'M6TXT':
                        window.M6TXT.setText(var1)
                    elif var2== 'M7TXT':
                        window.M7TXT.setText(var1)
                    elif var2== 'MIM':
                        ...
                        window.VIA4.setText(var1)
                    elif var2== 'VIA5':
                        window.VIA5.setText(var1)
                    elif var2== 'VIA6':
                        window.VIA6.setText(var1)
                    else:
