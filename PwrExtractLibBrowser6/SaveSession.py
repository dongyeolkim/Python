...
#    dialog.setViewMode(QtGui.QFileDialog.Detail)
    ...
    if file:
        try:
            ...
            f.write("M5TXT" + " " + window.M5TXT.text() + "\n")
            f.write("M6TXT" + " " + window.M6TXT.text() + "\n")
            f.write("M7TXT" + " " + window.M7TXT.text() + "\n")
            ...
            f.write("VIA4" + " " + window.VIA4.text() + "\n")
            f.write("VIA5" + " " + window.VIA5.text() + "\n")
            f.write("VIA6" + " " + window.VIA6.text() + "\n")
            f.close()
    else:
