...
# Form implementation generated from reading ui file 'tieviewer.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.powers = QtGui.QLineEdit(self.centralwidget)
        self.powers.setObjectName(_fromUtf8("powers"))
        self.verticalLayout_2.addWidget(self.powers)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 964, 19))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Spice Netlist", None))
        self.label_2.setText(_translate("MainWindow", "Power Names", None))
        self.browser.setText(_translate("MainWindow", "Browser", None))
